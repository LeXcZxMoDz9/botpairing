...
user.push({id: m.sender, level: "member", upharga: 5, product_name: "", tujuan: "", price: 0, saldo: 0, reff: "", jumlah: "", buyer_sku_code: "", tanggal_trx: "", status_topup: true, status_sosmed: true, status_deposit: true, status_deposit_otomatis: true, desc: "", deposit: "", reff_deposit: true, tanggal_deposit: "", link_sc: "", pw_script: "", fee_owner: 0})
fs.writeFileSync('./Pengaturan/database/user.json', JSON.stringify(user))
  ...
  *-----------------*
  ...
  for (let i of sos) {
    if (i.sid === produk) {
      ...
      let totalOrder = ((totalHarga * parseInt(jumlahh) / 1000) + 100).toFixed(0); // Mengalikan harga dengan jumlah dan menambahkan biaya tetap 100
